...
<div class="help-page">
    ...
    <div class="help-page__column help-page__column--right">
        ...
        <form action="?pag=notificacion" method="POST" class="help-page__form">
            ...
            <br>
            <div>
            <input type="submit" name="accion" class="help-page__button help-page__button--enviar" value="Enviar">
            <input type="submit" name="accion" class="help-page__button help-page__button--eliminar" value="Eliminar">
            </div>
